...
def get_mcp_tools(
    ...
    for server in servers:
        ...
        # AWS AgentCore requires terminate_on_close=False for stateless MCP servers
        # See: https://docs.aws.amazon.com/bedrock/latest/userguide/agentcore-runtime-deploy-mcp.html
        if headers:
            connection_params = StreamableHTTPConnectionParams(url=url, headers=headers, terminate_on_close=False)
        else:
            connection_params = StreamableHTTPConnectionParams(url=url, terminate_on_close=False)
